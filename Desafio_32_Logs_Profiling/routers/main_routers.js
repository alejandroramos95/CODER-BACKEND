...
function checkAutentication(req, res, next){
    logger.info("Intento de acceso a ruta protegida");
...
Router.get('/', async(req, res) =>{
    ...
    logger.info("Acceso a ruta main");
...
Router.get('/logout', (req, res) =>{
    ...
    logger.info("Acceso a ruta logout");
    res.redirect('/');
});
